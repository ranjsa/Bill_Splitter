...
public class Display_friendDetails extends AppCompatActivity {
   ...
   ArrayList<String> notes = new ArrayList<String>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listView1=findViewById(R.id.list_note);
                                ...
                                .setPositiveButton("Save",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int whichButton) {
                                                ...
                                                else  z=Float.parseFloat(input2.getText().toString());
                                                if(y==-1) z=(-1)*z;
                                                flag=0;
                                                if (y == 0 || input1.getText().toString().matches("") || input2.getText().toString().matches("")) {
        ...
        if (c != null) {
            ...
            if (c.moveToFirst()) {
                do {
                    ...
                    float d4 = Float.parseFloat(c.getString(c.getColumnIndex("amount")));
                    ...
                    case R.id.delete_id:
                        for (int i = vec.size() - 1; i > -1; i--) {
                            if (vec.get(i) == 0) {
                                ...
                                float amount = niitemlist.get(i).getAmount();
                                vec.set(i, 1);
                                listView.getChildAt(i).setBackgroundColor(Color.WHITE);
                                ...
                                if (c4 != null) {
                                    if (c4.moveToFirst()) {
                                        do {
                                            ...
                                            if (ch.matches(p)) {
                                                float money = c4.getInt(c4.getColumnIndex("amount"));
